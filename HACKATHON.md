# Practice to Create [Feedback To All Projects!]

**Event page:** https://practicetocreate.devpost.com/  ·  **Rules:** https://practicetocreate.devpost.com/rules
**Deadline:** **Fri Sep 25, 2026 · 12:45 PM EDT**  (`2026-09-25T12:45:00-04:00`)
> Devpost lists it as Sep 25, 2026 @ 11:45pm ICT (UTC+7) = 12:45 PM EDT.
...
- `submission/video/demo.mp4`: **3:00–5:00 long** (a hard requirement, not a suggestion)
- `submission/SOURCES-AND-AI.md`: every source, dataset, library, font, image and AI model/tool used (including Claude Code), stated truthfully
- `submission/deck.pdf`: a 8–10 slide deck, because Presentation + Visuals are 50% of the score

## Strategy notes (starting hypotheses, which the research may overturn)
- **Short fuse.** Compress research to one 30-minute pass (this organizer's past galleries plus 3–4 same-shape winners), then build.
- Half the score is Presentation + Visuals, so the video and the look of the thing matter as much as the code.
- Plausibility (25%) means the solution must obviously work in the real world. Use real data, real constraints and a named user.

**Suggested lane:** Open: an everyday or overlooked problem, with a visually striking result.
...
|---|---|---|---|
| [`practicetocreate`](https://github.com/rishikrrontala-bot/practicetocreate) | Practice to Create **← this repo** | Fri Sep 25, 2026 · 12:45 PM EDT | Open: an everyday or overlooked problem, with a visually striking result. |
